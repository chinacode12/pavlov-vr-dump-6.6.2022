...
public:
	...
	class UMaterialInterface*                          Material;                                                 // 0x0608(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	float                                              DamageMultiplier;                                         // 0x0170(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              KillImpulseMul;                                           // 0x0174(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	float                                              LowHealthThreshold;                                       // 0x01E0(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01E4(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnKill;                                                   // 0x01E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRevive;                                                 // 0x01F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHitEffect;                                              // 0x0208(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLowHealth;                                              // 0x0218(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
