...
{
public:
	struct FString                                     AtlasPath;                                                // 0x0028(0x0010) (Edit, ZeroConstructor, EditConst)
	...
	struct FString                                     PixelFormat;                                              // 0x0040(0x0010) (Edit, ZeroConstructor, EditConst)
...
{
public:
	struct FScriptMulticastDelegate                    ReadyForBindings;                                         // 0x00F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    BindingsReleased;                                         // 0x0100(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    ScriptingReady;                                           // 0x0110(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<class UTexture2D*>                          PreloadedTextures;                                        // 0x0120(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bEnableComplexCSSSupport;                                 // 0x0130(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0131(0x0007) MISSED OFFSET
	class UTextureRenderTarget2D*                      Texture;                                                  // 0x0138(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextureFilter>                        Filter;                                                   // 0x0140(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bReceiveInput;                                            // 0x0141(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDelayedUpdate;                                           // 0x0142(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseWideColorTextures;                                    // 0x0143(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x58];                                      // 0x0168(0x0058) MISSED OFFSET
...
{
public:
	struct FString                                     URL;                                                      // 0x01C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                Width;                                                    // 0x01D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Height;                                                   // 0x01D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               ManualTexture;                                            // 0x01D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x01D9(0x0007) MISSED OFFSET
	struct FName                                       PrimitiveName;                                            // 0x01E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCohtmlHUD*                                  CohtmlHUD;                                                // 0x0418(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCohtmlHUD*                                  CohtmlHUDInternal;                                        // 0x0420(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FSoftObjectPath                             HUDMaterialName;                                          // 0x01C0(0x0018) (ZeroConstructor)
	class UMaterial*                                   HUDMaterial;                                              // 0x01D8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInstanceDynamic*                    HUDMaterialInstance;                                      // 0x01E0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnCohtmlInputActorMouseButtonDown;                        // 0x0328(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCohtmlInputActorMouseButtonUp;                          // 0x0338(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCohtmlInputActorKeyDown;                                // 0x0348(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCohtmlInputActorKeyUp;                                  // 0x0358(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TArray<struct FString>                             InputTransparentCssClasses;                               // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
	...
	struct FString                                     DefaultStyleFontFamily;                                   // 0x0068(0x0010) (Edit, ZeroConstructor, Config)
	bool                                               AsynchronousResourceRequestCalls;                         // 0x0078(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseInputPreprocessor;                                    // 0x0079(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	bool                                               bUseWideColorTextures;                                    // 0x0155(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TArray<class UTexture2D*>                          PreloadedTextures;                                        // 0x0160(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UCohtmlAudioWrapper*                         AudioWrapper;                                             // 0x0170(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x78];                                      // 0x0178(0x0078) MISSED OFFSET
	struct FString                                     URL;                                                      // 0x01F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
