...
{
	static auto fn = UObject::FindObject<UFunction>("Function Vankrupt.VHealthComponent.SetDamageMultiplier");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Vankrupt.VHealthComponent.GetDamageMultiplier");
