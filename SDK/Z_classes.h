...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Z.LootCrate");
		return ptr;
	}
...
public:
	...
	class UClass*                                      VehicleClass;                                             // 0x0798(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsDead;                                                  // 0x07A0(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x17];                                      // 0x07A1(0x0017) MISSED OFFSET
	EZKnockBackState                                   KnockBackState;                                           // 0x07B8(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0xF];                                       // 0x07B9(0x000F) MISSED OFFSET
	float                                              LandedDelayTime;                                          // 0x07C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDelayedAirCollisions;                                    // 0x07CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xB];                                       // 0x07CD(0x000B) MISSED OFFSET
	EAIState                                           AIControllerState;                                        // 0x07D8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x07D9(0x0007) MISSED OFFSET
	class AActor*                                      AITarget;                                                 // 0x07E0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	EAIAttackState                                     AttackingState;                                           // 0x07E8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x17];                                      // 0x07E9(0x0017) MISSED OFFSET
	float                                              PoolAttackDelay;                                          // 0x0800(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAIClimbingState                                   ClimbingState;                                            // 0x0804(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0805(0x0003) MISSED OFFSET
	float                                              RandomSprintDelayCheckTime;                               // 0x0808(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RandomSprintChance;                                       // 0x080C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsSprinting;                                             // 0x0810(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x0811(0x0003) MISSED OFFSET
	float                                              StopSprintingDistance;                                    // 0x0814(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AttackRange;                                              // 0x0818(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CapsuleWidth;                                             // 0x081C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CapsuleLength;                                            // 0x0820(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DamageToPlayer;                                           // 0x0824(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DamageToObjects;                                          // 0x0828(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class AAIDirector*                                 AIDirector;                                               // 0x00F0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<class ACharacter*>                          ZBodies;                                                  // 0x00F8(0x0010) (ZeroConstructor)
	struct FTimerHandle                                AutoSpawnTimerHandle;                                     // 0x0108(0x0008)
	struct FAutoSpawnProperties                        AutoZSettings;                                            // 0x0110(0x0010) (BlueprintVisible, BlueprintReadOnly)
	int                                                ZAmountToSpawn;                                           // 0x0120(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                ZAlive;                                                   // 0x0124(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AIDirectorClass;                                          // 0x0128(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, NoClear, IsPlainOldData)
	int                                                MaxZBodies;                                               // 0x0130(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CashPerZKill;                                             // 0x0134(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UEnvQuery*                                   ZSpawnQuery;                                              // 0x0138(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoClear, IsPlainOldData)
	class UDataTable*                                  LootCrateTable;                                           // 0x0140(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UEnvQuery*                                   LootCrateEQS;                                             // 0x0148(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoClear, IsPlainOldData)
	class UClass*                                      LootCrateToSpawn;                                         // 0x0150(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnZKilled;                                                // 0x0158(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAutoSpawnFinished;                                      // 0x0168(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Z.ZSpawn");
		return ptr;
	}
