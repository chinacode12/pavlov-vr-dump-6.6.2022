...
enum class EMagSlideMode : uint8_t
{
...
enum class EMagSlideAxis : uint8_t
{
	EMagSlideAxis__X               = 0,
	EMagSlideAxis__Y               = 1,
	EMagSlideAxis__Z               = 2,
...
{
	TArray<class UObject*>                             LazyLoaded;                                               // 0x0000(0x0010) (ZeroConstructor)
};
...
{
	bool                                               bMagSlideInsert;                                          // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	struct FName                                       SlideStartSocket;                                         // 0x0008(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       SlideEndSocket;                                           // 0x0010(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EMagSlideAxis                                      MagSlideAxis;                                             // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	float                                              ReloadSpeedMultiplier;                                    // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SlideGoalThreshold;                                       // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     MagSlideBounds;                                           // 0x0024(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRotator                                    MagGoalRotOffset;                                         // 0x0030(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSlidePositive;                                           // 0x003C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	float                                              MaxSlideDistance;                                         // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              HandExploitThreshold;                                     // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
	class AVRGun*                                      Gun;                                                      // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FOnAsyncLoad
{
	struct FScriptDelegate                             OnAsyncLoadObject;                                        // 0x0000(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
};
