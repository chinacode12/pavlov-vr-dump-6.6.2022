...
// class AActor*                  OtherActor                     (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AZAICharacter::ShouldDamageOtherActor(class AActor* DamageTarget, class AActor** OtherActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZAICharacter.ShouldDamageOtherActor");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.ZombieKilled");
...
// class AActor*                  EQSContext                     (Parm, ZeroConstructor, IsPlainOldData)

void UZSpawn::SpawnLootCrate(const struct FName& LootCrateID, class AActor* EQSContext)
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.SpawnLootCrate");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.SetZombiesToAutoSpawn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.SetZBodyCount");
...
// (Final, BlueprintAuthorityOnly, Native, Public, BlueprintCallable)
// Parameters:
// int                            CashPerKill                    (Parm, ZeroConstructor, IsPlainOldData)

void UZSpawn::SetCashPerZKill(int CashPerKill)
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.SetCashPerZKill");
...
// (Final, BlueprintAuthorityOnly, Native, Public, BlueprintCallable)
// Parameters:
// struct FAutoSpawnProperties    AutoSpawnProperties            (Parm)

void UZSpawn::SetAutoSpawnProperties(const struct FAutoSpawnProperties& AutoSpawnProperties)
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.SetAutoSpawnProperties");
...
// Parameters:
// int                            Amount                         (Parm, ZeroConstructor, IsPlainOldData)
// TArray<struct FTransform>      RandomLocations                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.ManualSpawnZombies");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.ManualSpawnLootCrate");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.KillAllZombies");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.GetZombiesToAutoSpawn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.GetZombiesAliveCount");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.GetLootCrateClass");
...
// (Final, Native, Public)
// Parameters:
// class AAIDirector*             ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class AAIDirector* UZSpawn::GetAIDirector()
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.GetAIDirector");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.CleanupBodies");
...
// Parameters:
// int                            Amount                         (Parm, ZeroConstructor, IsPlainOldData)
// int                            AmtToSpawn                     (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UZSpawn::AddZombiesToAutoSpawn(int Amount, int* AmtToSpawn)
{
	static auto fn = UObject::FindObject<UFunction>("Function Z.ZSpawn.AddZombiesToAutoSpawn");
