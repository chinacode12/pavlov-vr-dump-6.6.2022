...
public:
	...
	struct FScriptDelegate                             ValueXDelegate;                                           // 0x0108(0x0014) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ValueYDelegate;                                           // 0x0118(0x0014) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0148(0x0014) (ZeroConstructor, InstancedReference)
